            ...
            <div class="modal-body m-3">
                <form method="get" action="">
                    <div class="text-center">
                        <img class="img-thumbnail rounded-circle" src="<?php echo BASE_URL . 'assets/img/shop_01.jpg'; ?>" width="100">
                    </div>
                    <div class="row">
                        <div class="col-md-12" id="frmLogin">
                            <div class="form-group mb-3">
                                <label for="correoLogin"><i class="fas fa-envelope"></i> Correo</label>
                                <input class="form-control" type="email" name="correoLogin" id="correoLogin" placeholder="Ingrese su correo">
                            </div>
                            <div class="form-group mb-3">
                                <label for="claveLogin"><i class="fas fa-key"></i>Contraseña</label>
                                <input class="form-control" type="password" name="claveLogin" id="claveLogin" placeholder="Ingrese su contraseña">
                            </div>
                        ...
                        <!-- d-none oculta por defecto el div de registro -->
                        <div class="col-md-12 d-none" id="frmRegister">
                            <div class="form-group mb-3">
                                <label for="nombreRegistro"><i class="fas fa-list"></i> Nombre</label>
                                <input class="form-control" type="text" name="nombreRegistro" id="nombreRegistro" placeholder="Ingrese su nombre completo">
                            </div>
                            <div class="form-group mb-3">
                                <label for="correoRegistro"><i class="fas fa-envelope"></i> Correo</label>
                                <input class="form-control" type="email" name="correoRegistro" id="correoRegistro" placeholder="Ingrese su correo">
                            </div>
                            <div class="form-group mb-3">
                                <label for="claveRegistro"><i class="fas fa-key"></i>Contraseña</label>
                                <input class="form-control" type="password" name="claveRegistro" id="claveRegistro" placeholder="Ingrese su contraseña">
                            </div>
                            <a href="#" id="btnLogin">¿Ya tienes una cuenta?</a>
                            <div class="float-end">
                                <button type="button" class="btn btn-primary btn-lg" id="registrarse">Registrase</button>
                            </div>
                        </div>
                    </div>
