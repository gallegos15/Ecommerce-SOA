                ...
                <ul class="list-unstyled templatemo-accordion">
                    ...
                    <li class="pb-3">
                        ...
                        <ul id="collapseTwo" class="collapse list-unstyled pl-3">
                            <li><a class="text-decoration-none" href="#">Populares</a></li>
                            <li><a class="text-decoration-none" href="#">Edición Limitada</a></li>
                        </ul>
                    </li>
                    <li class="pb-3">
                        <a class="collapsed d-flex justify-content-between h3 text-decoration-none" href="#">
                        ...
                        <ul id="collapseThree" class="collapse list-unstyled pl-3">
                            <li><a class="text-decoration-none" href="#">Urbanos</a></li>
                    ...
                    <ul class="pagination pagination-lg justify-content-end">
                        ...
                        if ($data['pagina'] > 1) {
                            echo '<li class="page-item">
                                <a class="page-link active rounded-0 mr-3 shadow-sm border-top-0 border-left-0 text-dark" href="'. $url . $anterior.'" >
                                Anterior</a>
                            </li>';
                        } 
